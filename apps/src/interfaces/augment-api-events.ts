...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    poeModule: {
      ClaimCreated: AugmentedEvent<ApiType, [AccountId32, Bytes]>;
      ClaimRevoked: AugmentedEvent<ApiType, [AccountId32, Bytes]>;
      ClaimTransfered: AugmentedEvent<ApiType, [AccountId32, AccountId32, Bytes]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
